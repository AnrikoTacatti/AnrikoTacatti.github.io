...
$(document).ready(function () {
    ...
    $(".header__hamburger").click(function () {
            $(".header__nav").fadeToggle(1000);
        }),

    $('.header__top-model-row').on("click", function (e) {
        e.preventDefault();
        $(e.target).toggleClass("active");
        $(".header__top-model__nav").fadeToggle(1000);
    });
